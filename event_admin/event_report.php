...
// Page title
$page_title = 'Event Report - ' . $event['event_name'];
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2"><?php echo htmlspecialchars($event['event_name']); ?> - Report</h1>
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="events.php" class="btn btn-sm btn-outline-secondary me-2">
                        <i class="bi bi-arrow-left"></i> Back to Events
                    </a>
                    <div class="btn-group me-2">
                        <a href="export_report.php?event_id=<?php echo $event_id; ?>&type=<?php echo $report_type; ?>" class="btn btn-sm btn-outline-primary">
                            <i class="bi bi-download"></i> Export to CSV
                        </a>
                        <a href="print_report.php?event_id=<?php echo $event_id; ?>&type=<?php echo $report_type; ?>" class="btn btn-sm btn-outline-secondary" target="_blank">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="btn-group" role="group" aria-label="Report Type">
                        <a href="event_report.php?event_id=<?php echo $event_id; ?>&type=attendance" class="btn btn-<?php echo $report_type == 'attendance' ? 'primary' : 'outline-primary'; ?>">
                            Gate-wise Attendance Report
                        </a>
                        <a href="event_report.php?event_id=<?php echo $event_id; ?>&type=meeting" class="btn btn-<?php echo $report_type == 'meeting' ? 'primary' : 'outline-primary'; ?>">
            ...
            <?php if (!$report_data || !$report_data['success']): ?>
            ...
            <?php elseif ($report_type == 'attendance'): ?>
                ...
                <div class="card mb-4">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">Gate-wise Attendance Report</h5>
                    </div>
                    <div class="card-body">
                        <!-- Event Info -->
                        <div class="row mb-4">
                        ...
                        <?php if (empty($report_data['gate_report'])): ?>
                            <div class="alert alert-info">
                                ...
                                <a href="manage_gates.php?event_id=<?php echo $event_id; ?>" class="btn btn-primary btn-sm">Manage Gates</a>
                            </div>
                        <?php else: ?>
                                    ...
                                    <tbody>
                                        <?php foreach ($report_data['gate_report'] as $gate): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="gate_stats.php?gate_id=<?php echo $gate['gate_id']; ?>&event_id=<?php echo $event_id; ?>" class="btn btn-sm btn-outline-primary">
                                                        View Details
                                                    </a>
                                                </td>
                                            </tr>
            ...
            <?php else: ?>
                ...
                <div class="card mb-4">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">Meeting / Delegates Report</h5>
                    </div>
                    <div class="card-body">
                        <!-- Event Info -->
                        <div class="row mb-4">
